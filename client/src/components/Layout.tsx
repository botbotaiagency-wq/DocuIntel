    ...
    <SidebarProvider style={{ "--sidebar-width": "17rem", "--sidebar-width-icon": "4rem" } as React.CSSProperties}>
      <div className="flex h-[100dvh] w-full bg-background overflow-hidden text-foreground">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <header className="flex h-14 sm:h-16 shrink-0 items-center gap-3 sm:gap-4 border-b border-border/50 bg-card/50 backdrop-blur-md px-4 sm:px-6 z-10">
            <SidebarTrigger className="text-muted-foreground hover:text-foreground" />
            <div className="h-4 w-px bg-border mx-1 sm:mx-2"></div>
            <h1 className="text-base sm:text-lg font-semibold font-display tracking-tight text-foreground truncate">{getTitle()}</h1>
          </header>
