...
export default function ReviewQueue() {
  ...
  return (
    <div className="space-y-6" data-testid="page-review-queue">
      <div>
        <h2 className="text-2xl font-bold tracking-tight" data-testid="text-review-title">Review Queue</h2>
        <p className="text-muted-foreground">Documents requiring human review before approval.</p>
      </div>
